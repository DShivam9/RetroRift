 ...
 * Generated at: 2026-04-29T13:12:21.593Z
 * Total games: 22
 * 
...
export const games = [
  {
    ...
    "description": "The foundation of a global phenomenon. Embark on your journey to catch all 151 Pokémon and become the Champion of the Kanto region.",
    "difficulty": "Medium",
    "playtime": "20-30 hours",
    "rating": 4.8,
    "features": ["151 Pokémon", "SGB Enhanced", "8 Gym Badges", "Elite Four"]
  },
  {
    "id": 2,
    ...
    "genre": "RPG",
    "developer": "Game Freak",
    "description": "Special Pikachu Edition. Experience the original Johto journey with a loyal Pikachu by your side, inspired by the classic anime series.",
    "difficulty": "Medium",
    "playtime": "20-30 hours",
    "rating": 4.9,
    "features": ["Anime-inspired", "Pikachu Follows", "All Starters", "GBC Enhanced"]
  },
  {
    "id": 3,
    ...
    "description": "An ambitious crossover where Crash enters the world of Spyro. Battle Ripto and Cortex in a unique blend of platforming and mini-games.",
    "difficulty": "Medium",
    "playtime": "6-10 hours",
    "rating": 4.2,
    "features": ["Spyro Crossover", "Mini-games", "GBA Visuals", "Boss Battles"]
  },
  {
    "id": 4,
  ...
  },
  {
    ...
    "genre": "RPG",
    "developer": "Game Freak",
    "description": "The pinnacle of the second generation. Explore the Johto region with animated sprites, the Suicune subplot, and the debut of the Battle Tower.",
    "difficulty": "Medium",
    "playtime": "30-50 hours",
    "rating": 4.9,
    "features": ["Day/Night Cycle", "Animated Sprites", "Battle Tower", "Suicune Story"]
  },
  {
    "id": 15,
    ...
    "description": "A high-octane return to Liberty City. Use the touch screen to hijack cars, hotwire ignitions, and build your criminal empire.",
    "difficulty": "Medium-Hard",
    "playtime": "15-25 hours",
    "rating": 4.6,
    "features": ["Touch Screen Hijacking", "Drug Dealing Sim", "Stylized Graphics", "PDA Interface"]
  },
  {
    "id": 16,
  ...
  },
  {
    ...
    "description": "A direct sequel to The Wind Waker. Navigate the Great Sea and solve intricate puzzles using the NDS's innovative touch controls.",
    "difficulty": "Medium",
    "playtime": "15-20 hours",
    "rating": 4.7,
    "features": ["Full Touch Controls", "Ship Navigation", "Temple of Ocean King", "Phantom Hourglass"]
  },
  {
    "id": 22,
    "title": "Pac-Man",
